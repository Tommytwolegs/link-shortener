...
Plain, dependency-free JavaScript with 2,710 unit tests: https://github.com/Tommytwolegs/link-shortener
...
Reminder for the v1.8.0 AMO notes: 121 sites (119 toggles) / 332 host permissions / 2,710 tests; the extension is unchanged architecturally — every module is a pure URL function.
