...
const CASES = [
  ...
  { name: 'mobile /vm/ form cleaned (verified live: m.coupang.com shares)',
    input: 'https://m.coupang.com/vm/products/7184087387?itemId=123&src=mobile_share&spec=10305',
    expected: 'https://m.coupang.com/vm/products/7184087387?itemId=123' },
  { name: 'mobile /vm/ already clean',
    input: 'https://m.coupang.com/vm/products/175573004',
    expected: 'https://m.coupang.com/vm/products/175573004',
    expectedNeeds: false },
  { name: '/vm/products/ non-numeric sub-path → null',
    input: 'https://m.coupang.com/vm/products/coupon/first-app-usage',
    expected: null },
