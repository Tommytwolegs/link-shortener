...
const CASES = [
  ...
  { name: 'Mercari Shops product cleaned',
    input: 'https://jp.mercari.com/shops/product/3vRbkTNQiiUYyBZi8FYcZf?utm_source=share&source_location=shops',
    expected: 'https://jp.mercari.com/shops/product/3vRbkTNQiiUYyBZi8FYcZf' },
  { name: 'Mercari Shops already clean',
    input: 'https://jp.mercari.com/shops/product/abc123XYZ',
    expected: 'https://jp.mercari.com/shops/product/abc123XYZ',
    expectedNeeds: false },
  { name: 'shops root → null',
    input: 'https://jp.mercari.com/shops',
    expected: null },
  { name: 'search → null',
