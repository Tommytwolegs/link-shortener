...
const CASES = [
  ...
  { name: '/i/lists already clean',
    ...
    expectedNeeds: false },
  { name: '/i/lists non-numeric: passthrough via fallback (no junk)',
    input: 'https://x.com/i/lists/abc',
    expected: 'https://x.com/i/lists/abc',
    expectedNeeds: false },
  // Fallback denylist on non-post pages
  { name: 'profile share junk (?s=&t=) stripped via fallback',
    input: 'https://x.com/jack?s=21&t=AbCdEfGh123',
    expected: 'https://x.com/jack' },
  { name: 'ref_src stripped on embedded profile link',
    input: 'https://twitter.com/jack?ref_src=twsrc%5Etfw',
    expected: 'https://twitter.com/jack' },
  { name: 'search: q + f SURVIVE fallback',
    input: 'https://x.com/search?q=hello&f=live&s=21',
    expected: 'https://x.com/search?q=hello&f=live' },
  ...
  { name: 'hash preserved alongside tracking strip',
    input: 'https://x.com/jack/status/20?s=20#m',
    expected: 'https://x.com/jack/status/20#m' },
