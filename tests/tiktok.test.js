...
const CASES = [
  { name: 'profile share: _t/_r stripped via fallback',
    input: 'https://www.tiktok.com/@someuser?_t=8kAbCdEf&_r=1',
    expected: 'https://www.tiktok.com/@someuser' },
  ...
  { name: 'share/photo non-numeric → null',
    ...
    expected: 'https://www.tiktok.com/share/photo/abc',
    expectedNeeds: false },
  ...
  { name: '/share/video/ non-numeric id → null',
    ...
    expected: 'https://www.tiktok.com/share/video/abc',
    expectedNeeds: false },
  ...
  { name: 'profile page → null',
    ...
    expected: 'https://www.tiktok.com/@user',
    expectedNeeds: false },
  { name: 'home → null',
    input: 'https://www.tiktok.com/',
    expected: 'https://www.tiktok.com/',
    expectedNeeds: false },
  { name: 'foryou → null',
    input: 'https://www.tiktok.com/foryou',
    expected: 'https://www.tiktok.com/foryou',
    expectedNeeds: false },
