...
const CASES = [
  ...
  { name: 'disco comment deep-link PRESERVED',
    input: 'https://docs.google.com/document/d/1AbC/edit?disco=AAABZxKw9nM&usp=comment_email_document',
    expected: 'https://docs.google.com/document/d/1AbC/edit?disco=AAABZxKw9nM' },
  { name: 'tab (document tabs) PRESERVED',
    input: 'https://docs.google.com/document/d/1AbC/edit?tab=t.abc123xyz&usp=sharing',
    expected: 'https://docs.google.com/document/d/1AbC/edit?tab=t.abc123xyz' },
  { name: 'gid + tab together',
    input: 'https://docs.google.com/spreadsheets/d/1XyZ/edit?gid=42&tab=t.0&ouid=999',
    expected: 'https://docs.google.com/spreadsheets/d/1XyZ/edit?gid=42&tab=t.0' },
  { name: 'already clean',
