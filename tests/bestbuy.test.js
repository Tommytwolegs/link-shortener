...
const CASES = [
  ...
  { name: 'canada en-ca/product form cleaned (verified live)',
    input: 'https://www.bestbuy.ca/en-ca/product/apple-airpods-max-silver/15204589?icmp=recos_pdp',
    expected: 'https://www.bestbuy.ca/en-ca/product/apple-airpods-max-silver/15204589' },
  { name: 'canada slugless product form cleaned',
    input: 'https://www.bestbuy.ca/en-ca/product/15459513?cmp=x',
    expected: 'https://www.bestbuy.ca/en-ca/product/15459513' },
  { name: 'canada french storefront cleaned',
    input: 'https://www.bestbuy.ca/fr-ca/product/xbox-controller/14965239?icmp=a',
    expected: 'https://www.bestbuy.ca/fr-ca/product/14965239'.replace('/product/14965239','/product/xbox-controller/14965239') },
  { name: 'US multi-segment slug tolerated',
    input: 'https://www.bestbuy.com/site/apple/airpods-pro/6447382.p?ref=212',
    expected: 'https://www.bestbuy.com/site/apple/airpods-pro/6447382.p' },
  { name: 'hash preserved',
