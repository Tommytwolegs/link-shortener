...
const CASES = [
  ...
  { name: 'watch: list + index preserved (playlist context)',
    input: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=PLabc&index=1',
    expected: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=PLabc&index=1' },
  { name: 'watch: list + index preserved alongside t + tracking stripped',
    input: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ&list=PLabc&index=5&t=42s&si=X',
    expected: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ&t=42s&list=PLabc&index=5' },
  { name: 'playlist: index preserved alongside list',
    input: 'https://www.youtube.com/playlist?list=PLabc&index=7&si=X',
    expected: 'https://www.youtube.com/playlist?list=PLabc&index=7' },
  ...
  { name: 'watch: hash preserved when already clean',
    input: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ#fragment',
    expected: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ#fragment',
    expectedNeeds: false },
  { name: 'shorts: hash preserved',
    input: 'https://www.youtube.com/shorts/abc123?si=X#chapter1',
    expected: 'https://www.youtube.com/shorts/abc123#chapter1' },
