...
Four ways to get a clean link: URLs on supported sites are rewritten
in place as you browse; right-click any link or page and choose "Copy
clean URL"; press Ctrl+Shift+L (Cmd+Shift+L on Mac) to copy a clean
URL of the current page; and clicking a link wrapped by a click-tracker,
social outbound wrapper, affiliate wrapper, or AMP viewer lands straight
on the real destination ("Skip redirect pages", on by default — Outlook
...
- **Global** — Search & productivity: Google Search, Google Drive/Docs,
  ...
  Sports: ESPN, Flashscore, Sofascore
...
- **Asia-Pacific** — Shopping: Shopee, Lazada, Tokopedia, Coupang,
  ...
  Search & portals: Naver, Yahoo! Japan Search, Daum · Social &
  knowledge: Zhihu, Weibo, Niconico · More shopping: Gmarket, 11st,
  Myntra, Daraz · Food: Zomato, Swiggy
- **Europe** — Shopping: Vinted, Allegro, Leboncoin, OLX, Wallapop,
  Marktplaats, Kleinanzeigen, Zalando, Bol.com, OTTO, MediaMarkt,
  Cdiscount, Fnac, Trendyol, Hepsiburada, Wildberries, Ozon, Avito
